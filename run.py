...
if __name__ == "__main__":
	errmsg = "\n"
	for i in ID.keys():
		submit = Submit(headers = global_headers, runtime_path = runtime_path, name = None, longitude = global_longitude, latitude = global_latitude, address = global_address, info = info)
		try:
